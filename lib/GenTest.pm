...
@EXPORT = ('say', 'sayError', 'sayFile', 'tmpdir', 'safe_exit', 'osWindows', 'osLinux', 'osSolaris', 'osMac','isoTimestamp', 'isoUTCTimestamp', 'isoUTCSimpleTimestamp', 'rqg_debug', 'unix2winPath','setLoggingToFile','setLogConf','shorten_message');
