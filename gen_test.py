...
def parse_args():
    ...
    parser.add_argument("--host", dest="host", help="Server address. DEFAULT: localhost", default="localhost")
    ...
    parser.add_argument("--passwd", dest="passwd", help="Passwd for the user. DEFAULT: '123456'", default="123456")
    parser.add_argument("--database", dest="database", help="Database to use. DEFAULT: test", default="test")
